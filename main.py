...
def main():
    ...
    schema_get_file_content = types.FunctionDeclaration(
        ...
        description="Reads and returns the content of a file in a string format, constrained to the working directory.",
        parameters=types.Schema(
            type=types.Type.OBJECT,
            properties={
    ...
    schema_run_python_file = types.FunctionDeclaration(
        ...
        description="Runs the python code of a file, constrained to the working directory.",
        parameters=types.Schema(
            type=types.Type.OBJECT,
            properties={
                "file_path": types.Schema(
    ...
    schema_write_file = types.FunctionDeclaration(
        name="write_file",
        description="Writes the content the file, overwritting it, constrained to the working directory.",
        parameters=types.Schema(
            type=types.Type.OBJECT,
            properties={
                "file_path": types.Schema(
                ...
                "content": types.Schema(
                    type=types.Type.STRING,
                    description="The content to writte to the file",
                ),
            },
        ),
    )
